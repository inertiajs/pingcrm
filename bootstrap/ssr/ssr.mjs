...
default_1(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/Login.vue": () => import("./assets/Login.431176b7.mjs"), "./Pages/Contacts/Create.vue": () => import("./assets/Create.8b2dd686.mjs"), "./Pages/Contacts/Edit.vue": () => import("./assets/Edit.25e567ed.mjs"), "./Pages/Contacts/Index.vue": () => import("./assets/Index.3f1be823.mjs"), "./Pages/Dashboard/Index.vue": () => import("./assets/Index.abfec80e.mjs"), "./Pages/Organizations/Create.vue": () => import("./assets/Create.3592bfb8.mjs"), "./Pages/Organizations/Edit.vue": () => import("./assets/Edit.30b5fabe.mjs"), "./Pages/Organizations/Index.vue": () => import("./assets/Index.506872d2.mjs"), "./Pages/Reports/Index.vue": () => import("./assets/Index.50e14b83.mjs"), "./Pages/Users/Create.vue": () => import("./assets/Create.a889bb87.mjs"), "./Pages/Users/Edit.vue": () => import("./assets/Edit.1737da1a.mjs"), "./Pages/Users/Index.vue": () => import("./assets/Index.e5a6c791.mjs") })),
    setup({ app, props, plugin }) {
      return createSSRApp({ render: () => h$1(app, props) }).use(plugin).use(I, Ziggy, {
        ...page.props.ziggy,
