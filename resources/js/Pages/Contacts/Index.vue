<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">Responsables</h1>
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-indigo" href="/contacts/create">
        <span>Ajouter</span>
        <span class="hidden md:inline">&nbsp;Responsable</span>
      </Link>
    </div>
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        <tr class="text-left font-bold">
          ...
          <th class="pb-4 pt-6 px-6">Agence</th>
        ...
        <tr v-if="contacts.data.length === 0">
          <td class="px-6 py-4 border-t" colspan="4">Pas de responsable trouvé.</td>
        </tr>
      </table>
    </div>
