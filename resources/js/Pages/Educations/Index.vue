<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Educations</h1>
    ...
    <pagination class="mt-6" :links="educations.links" />
  </div>
</template>
  ...
  watch: {
    form: {
      handler: throttle(function() {
        ...
        this.$inertia.replace(this.route('educations', Object.keys(query).length ? query : { remember: 'forget' }))
      }, 150),
      deep: true,
    },
  },
