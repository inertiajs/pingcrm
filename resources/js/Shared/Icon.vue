<template>
  ...
  <svg v-else-if="name === 'product'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
      d="M12 0C5.371 0 0 5.371 0 12s5.371 12 12 12 12-5.371 12-12S18.629 0 12 0zm0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10zm-2-16h4v2h-4zm-1 4h6v10h-6z" />
  </svg>
  <svg v-else-if="name === 'invoice'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
      d="M16 2H8C6.343 2 5 3.343 5 5v14c0 1.657 1.343 3 3 3h8c1.657 0 3-1.343 3-3V5c0-1.657-1.343-3-3-3zM8 4h8c.553 0 1 .447 1 1v2H7V5c0-.553.447-1 1-1zm9 13H7v-2h10v2zm0-4H7v-2h10v2zm-1-8h-8v2h8V5z" />
  </svg>


  <svg v-else-if="name === 'download'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <path
